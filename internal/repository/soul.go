...
func (repo *SoulRepo) CreateSoul(ctx context.Context, so types.Soul) error {
	s := types.MapS(so)
	return repo.db.WithContext(ctx).Create(&s).Error
}

// ReadSoulsByScope helps you to read soul data by scope
func (repo *SoulRepo) ReadSoulsByScope(ctx context.Context, scope string) ([]types.Soul, error) {
...
func (repo *SoulRepo) ReadSoulsByCreator(ctx context.Context, creator string) ([]types.Soul, error) {
	var allSoul []dbtypes.Soul
...
func (repo *SoulRepo) GetSoul(ctx context.Context, name string) (types.Soul, error) {
...
func (repo *SoulRepo) GetAllSouls(ctx context.Context) ([]types.Soul, error) {
	var allSoul []dbtypes.Soul
	err := repo.db.WithContext(ctx).Find(&allSoul).Error
	if err != nil {
		return nil, err
...
func (repo *SoulRepo) UpdateSoulScope(ctx context.Context, name string, scope []string) error {
...
func (repo *SoulRepo) UpdateSoulContent(ctx context.Context, name string, content string) error {
...
func (repo *SoulRepo) AppendSoulScope(ctx context.Context, name string, scope string) error {
...
func (repo *SoulRepo) DeleteSoul(ctx context.Context, name string) error {
