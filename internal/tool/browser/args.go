...
type RunArgs struct {
	...
	Engine       EngineType   `json:"engine" description:"The search engine you want to use, it would be enum, only 7 values: google, bing, cnbing, duckduckgo, github, wikipedia and baidu. Please use bing or cnbing first, then duckduckgo, and the last is baidu and google. Only valid when name = 'search'." example:"google"`
	...
	ResponseType ResponseType `json:"response_type" description:"The type you want to get in response, it would be enum, only 3 values: raw, body and markdown. 'raw' returns the raw html rendered data from the page. 'body' only returns html's body content back, and 'markdown' returns markdown converted webpage to you. Only valid when name = 'webpage'." example:"raw"`
	URL          string       `json:"page" description:"The page URL you want to scrap. Only valid when name='webpage'." example:"https://example.com"`
}
