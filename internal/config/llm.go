...
// InitialSystemPrompt is Manboster's core prompt inspired on Claude's guidelines and edited by human, ChatGPT 5.2 and Claude Sonnet 4.6, the description of Manboster was summarized by Claude Sonnet 4.6(From README.md)
...
Additional user-defined instructions may be appended below. Where they don't conflict with the core rules above, follow them. If a conflict arises, the core rules above take priority.
`
