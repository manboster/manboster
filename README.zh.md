...
12. [开发中功能] 基于 Wasm 和 Extism 的插件系统，它不仅轻量，还能防止恶意插件破坏你的机器。
13. [开发中功能] MamboHub，一个让你可以轻松下载并使用技能与插件的分发中心。
14. [开发中功能] 使用 .manboplugin 文件安装插件，您甚至可以使用 manbodev 辅助工具来开发和编写自己的插件！
